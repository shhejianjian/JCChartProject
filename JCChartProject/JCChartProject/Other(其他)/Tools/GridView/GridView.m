...
-(void)setupUI
{
    normalImage = [UIImage imageNamed:@"bg-1"];
    ...
    for (NSInteger index = 0; index < self.showGridTitleArray.count; index++) {
        ...
        GridButton *gridItem =[[GridButton alloc]initWithFrame:CGRectZero title:gridTitle normalImage:normalImage highlightedImage:highlightedImage girdId:gridID atIndex:index isAddDelete:isAddDelete deleteImage:deleteIconImage withIconImageString:gridImage andObjectId:objectId];
