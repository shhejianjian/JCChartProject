...
- (void)buttonAction:(UIButton *)sender
{
    ...
    if ([self.delegate respondsToSelector:@selector(didSelectTableViewHeaderFooterView:)]) {
        [self.delegate didSelectTableViewHeaderFooterView:sender.tag];
    }
}
...
//    self.personNumberLabel.frame = CGRectMake(self.frame.size.width - 85, 0, 80, self.frame.size.height);
//    self.personNumberLabel.font = [UIFont systemFontOfSize:13];
//    self.personNumberLabel.textColor = [UIColor darkGrayColor];
}
